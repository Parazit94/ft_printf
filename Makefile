...
#    Updated: 2019/02/03 15:54:54 by ltuffleb         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
$(ALL_OBJS): $(ALL_SRCS)
	gcc $(FLAGS) -I $(LIBFT_PATH)$(LIB_FOLDER) -c $(ALL_SRCS) -I $(LIB_FOLDER) &&\
	ar rc $(NAME_LFT) $(ALL_OBJS) &&\
	ranlib $(NAME_LFT)
